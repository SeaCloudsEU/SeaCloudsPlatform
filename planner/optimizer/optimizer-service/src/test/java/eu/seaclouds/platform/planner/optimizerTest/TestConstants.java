...
public class TestConstants {
   ...
   public static final String CLOUD_OFFER_FILENAME_OPENSHIFT  = "./src/test/resources/mmOutputExample20Oct.json";
   public static final String OUTPUT_FILENAME       = "./src/test/target/outputNewTOSCA";
