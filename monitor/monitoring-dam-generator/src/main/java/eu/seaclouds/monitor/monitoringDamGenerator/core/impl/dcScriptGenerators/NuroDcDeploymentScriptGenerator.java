...
public class NuroDcDeploymentScriptGenerator implements
    ...
    private static final String dataCollectorArtifactURL = "https://www.dropbox.com/s/vq7g8btiolslbge/nuro-data-collector-"
            + dataCollectorVersion + "-jar-with-dependencies.jar";
    ...
    public String generateDataCollectorDeploymentScript(Module moduleInfo,
        ...
        sb.append("wget -O nuro-data-collector.jar " + dataCollectorArtifactURL
                + "\n");
