...
public class NuroApplicationDC implements Observer {
    ...
    private static Logger logger = LoggerFactory
            .getLogger(NuroApplicationDC.class);

    private static DCAgent dcAgent;
    private static InternalComponent application;
    ...
    public void startMonitor() throws ConfigurationException {
        ...
        if (config.getInternalComponentId() != null) {
            ...
            dcDescriptor.addMonitoredResource(
                    MetricManager.getApplicationMetrics(),
        ...
        application = new InternalComponent();
        application.setType("NuroApplication");
    ...
    public static boolean shouldMonitor(String metric) {
        ...
        return dcAgent.shouldMonitor(application, metric);
    }

    public static void send(String metric, Object toSend) {

        dcAgent.send(application, metric, toSend);
    }
