...
public class PythonPaasWebAppCloudFoundryDriver extends PaasWebAppCloudFoundryDriver implements PythonPaasWebAppDriver {

    public static final Logger log = LoggerFactory.getLogger(PythonPaasWebAppCloudFoundryDriver.class);

    public PythonPaasWebAppCloudFoundryDriver(PythonCloudFoundryPaasWebAppImpl entity, CloudFoundryPaasLocation location) {
        super(entity, location);
    }

    @Override
    public PythonCloudFoundryPaasWebAppImpl getEntity() {
        return (PythonCloudFoundryPaasWebAppImpl) super.getEntity();
    }
