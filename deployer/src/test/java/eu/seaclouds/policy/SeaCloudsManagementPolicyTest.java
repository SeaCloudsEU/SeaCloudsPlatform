...
public class SeaCloudsManagementPolicyTest {
    private static final Logger log = LoggerFactory.getLogger(SeaCloudsManagementPolicyTest.class);
    ...
    private static final String SLA_ENDPOINT = "http://52.36.119.104:9003";
    private static final String T4C_ENDPOINT = "http://52.48.187.2:8170";
    private static final String INFLUXDB_ENDPOINT = "http://52.48.187.2:8086";
    ...
    public void testAttachPolicyToApplication() {
        ...
        app.policies().add(PolicySpec.create(SeaCloudsManagementPolicy.class)
                .configure(SeaCloudsManagementPolicy.SLA_ENDPOINT, SLA_ENDPOINT)
                .configure(SeaCloudsManagementPolicy.SLA_AGREEMENT, BASE64_AGREEMENT)
                .configure(SeaCloudsManagementPolicy.T4C_ENDPOINT, T4C_ENDPOINT)
                .configure(SeaCloudsManagementPolicy.T4C_RULES, BASE64_RULES)
